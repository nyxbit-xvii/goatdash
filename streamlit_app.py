...
STATIC_W, STATIC_H, STATIC_ZOOM = 800, 600, 18  # small & fast
...
# --- MP4 generation (no default args that reference globals) ---
def _get_font():
    try:
...
def render_mp4_safe(interp: pd.DataFrame,
    ...
    # Try libx264, fall back to mpeg4 for hosts missing x264
    codecs = [
